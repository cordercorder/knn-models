...
from knn_models.knn_utils import KnnSearch
from knn_models.hook_utils import (
    ForwardHook, 
    DimReduceForwardHook,
)
from knn_models.knn_sequence_scorer import KnnSequenceScorer
...
def eval_lm(
    ...
    forward_hook: Union[ForwardHook, DimReduceForwardHook], 
    knn_search: KnnSearch,
    recompute_distance: bool,
    ...
    scorer = KnnSequenceScorer(forward_hook, knn_search, recompute_distance, target_dictionary, softmax_batch)
...
def main(cfg: DictConfig, **unused_kwargs):
    ...
    results = eval_lm(
        models=models,
        forward_hook=task.forward_hook,
        knn_search=task.knn_search,
        recompute_distance=task.args.recompute_distance,
