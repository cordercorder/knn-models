...
def get_parser():
    ...
    parser.add_argument(
        ...
        required=True, 
        help="method used for pruning datastore"
    )
    ...
    if args.method == "greedy_merge":
        ...
        parser.add_argument(
            ...
            type=int, 
            default=100, 
            help="print the progress in an interval during retrieving k-nearest neighbors "
            "for each keys in the datastore"
        )
        
    elif args.method == "random_pruning":
        parser.add_argument(
            "--pruned-datastore-size", 
            type=int, 
            required=True, 
        ...
        parser.add_argument(
            ...
            type=int, 
            default=2,
            help="minumum number of samples to get when adopt uniform sampling on each group"
        )
    
    elif args.method == "plac_pruning":
        ...
        parser.add_argument(
            ...
            type=str,
            required=True,
            help="the stage of plac pruning"
        )

        args, unknown = parser.parse_known_args()
        
        if args.plac_stage == "get_plac_pruning_candicate":
            parser.add_argument(
                "--use-gpu", 
                action="store_true", 
                default=False, 
            ...
            parser.add_argument(
                ...
                type=float, 
                required=True,
                help="the pruning ratio of datastore"
            )
